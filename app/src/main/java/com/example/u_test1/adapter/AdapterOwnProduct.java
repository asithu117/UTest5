...
import com.example.u_test1.SellerProductDetail;
...
public class AdapterOwnProduct extends RecyclerView.Adapter<AdapterOwnProduct.MyHolder>{
    Context context;
    ...
    String myUid;
    public AdapterOwnProduct(Context context, List<productPost> postList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.btnComment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(context,SellerProductDetail.class);
                i.putExtra("pId",pId);
